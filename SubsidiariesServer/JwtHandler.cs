...
namespace SubsidiariesServer
{
    public class JwtHandler(IConfiguration configuration, UserManager<SubsdiariesUsers> userManager)
    {
        //Generates the JWT token.
        public async Task<JwtSecurityToken> GetTokenAsync(SubsdiariesUsers user) =>
        new(
        ...
        private async Task<List<Claim>> GetClaimsAsync(SubsdiariesUsers user)
        {
